...
<p style="text-align:justify">Having motivated the DP example of adding noise from a probability distribution for a given query , Laplace mechanism is a DP mechanism where you add noise sampled from a Laplacian distribution to query result.The Laplace distribution is very suitable for DP because of its sharp rise and fall which for a given standard deviation (or epsilon) has lesser chances of values being sample being close to each other.</p>
...
<center>
<img src="https://i.stack.imgur.com/pjALo.png"></img>
</center>

<h2>Counting Query</h2>
<center>
<img height="200px" width="300px" src="Images/759297958b.png">
</center>
